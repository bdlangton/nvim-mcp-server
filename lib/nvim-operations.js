...
export async function openFile(filePath) {
  ...
  try {
    ...
    // Escape the path to prevent command injection via special characters
    const escapedPath = await nvim.call("fnameescape", [absolutePath]);
    await nvim.command(`edit ${escapedPath}`);
